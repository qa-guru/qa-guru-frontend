...
import { ISendHomeWork, ISendHomeWorkContent } from "./SendHomeworkItem.types";
...
const SendHomeworkItem: React.FC<ISendHomeWork> = (props) => {
...
export default SendHomeworkItem;
